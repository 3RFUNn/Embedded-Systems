###########################################################################
## Makefile generated for component 'controllers'. 
## 
## Makefile     : controllers.mk
## Generated on : Sat Jul 01 05:14:49 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/controllers.elf
...
START_DIR                 = C:/Users/PARSAN~1/Desktop/BORJAN~1/MATLAB~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/PARSAN~1/DOCUME~1/MATLAB/R2022a/ARDUIN~1/ARDUIN~2/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/controllers.elf
...
DEFINES_STANDARD = -DMODEL=controllers -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = controllers.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/controllers_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/controllers_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controllers_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
controllers.o : $(START_DIR)/controllers_ert_rtw/controllers.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/controllers_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
