...
#include "master_chart.h"
#include "rtwtypes.h"

/* Named constants for Chart: '<Root>/master_chart' */
...
/* Function for Chart: '<Root>/master_chart' */
static uint8_T button_pressed(const uint8_T old_state[8], const uint8_T
    current_state[8])
{
    uint8_T result;
...
/* Model step function */
void master_chart_step(void)
{
    int16_T i;

    /* Chart: '<Root>/master_chart' incorporates:
     *  Inport: '<Root>/button'
     ...
     *  Outport: '<Root>/leds'
     */
    if (rtDW.is_active_c2_master_chart == 0U) {
        rtDW.is_active_c2_master_chart = 1U;
        ...
        rtDW.is_c2_master_chart = IN_startup;
    } else {
        switch (rtDW.is_c2_master_chart) {
          case IN_bus_idle:
            if (((rtDW.retrieve_timeout == 0) | (rtDW.last_selected_device !=
                ...
                rtDW.phy_addr = rtU.selected_device;
                rtDW.reg_addr = 128U;
                rtDW.is_c2_master_chart = IN_retrieve_leds;
                ...
                rtDW.phy_addr = rtU.selected_device;
                rtDW.reg_addr = 0U;
                rtDW.is_c2_master_chart = IN_update_leds;
            } else if (rtDW.retrieve_timeout > 0) {
                rtDW.retrieve_timeout--;
                rtDW.is_c2_master_chart = IN_bus_idle;
            }
            break;
          ...
          case IN_process_data:
            ...
            rtY.command = MASTER_IDLE;
            rtDW.idle_clocks = 0U;
            rtDW.is_c2_master_chart = IN_wait_bus_idle;
            break;
          ...
          case IN_read_data:
            if (rtU.data_available) {
                ...
                rtDW.is_c2_master_chart = IN_process_data;
            }
            break;
          ...
          case IN_retrieve_leds:
            ...
            rtDW.is_c2_master_chart = IN_send_physical_address;
            break;
          ...
          case IN_send_physical_address:
            ...
            rtDW.is_c2_master_chart = IN_send_register_address;
            break;
          ...
          case IN_send_register_address:
            switch (rtDW.reg_addr) {
              case 0:
                ...
                rtDW.is_c2_master_chart = IN_put_data;
                break;
              ...
              case 128:
                ...
                rtDW.is_c2_master_chart = IN_read_data;
                break;
            }
            break;
    ...
    /* End of Chart: '<Root>/master_chart' */
}

/* Model initialize function */
void master_chart_initialize(void)
{
    /* Registration code */
