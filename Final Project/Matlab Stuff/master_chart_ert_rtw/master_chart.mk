###########################################################################
## Makefile generated for component 'master_chart'. 
## 
## Makefile     : master_chart.mk
## Generated on : Sat Jul 01 03:15:42 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/master_chart.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/master_chart.elf
...
DEFINES_STANDARD = -DMODEL=master_chart -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = master_chart.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/master_chart_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/master_chart_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/master_chart_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/master_chart_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


master_chart.o : $(START_DIR)/master_chart_ert_rtw/master_chart.c
	$(CC) $(CFLAGS) -o "$@" "$<"
