###########################################################################
## Makefile generated for component 'HW3_Q2'. 
## 
## Makefile     : HW3_Q2.mk
## Generated on : Tue Jun 06 17:22:48 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/HW3_Q2.elf
...
START_DIR                 = D:/Telegram/Embedded Systems/HW8/Q3/Simulation
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/HW3_Q2.elf
...
DEFINES_STANDARD = -DMODEL=HW3_Q2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = HW3_Q2.o HW3_Q2_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/HW3_Q2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/HW3_Q2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/HW3_Q2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
HW3_Q2.o : $(START_DIR)/HW3_Q2_ert_rtw/HW3_Q2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


HW3_Q2_data.o : $(START_DIR)/HW3_Q2_ert_rtw/HW3_Q2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/HW3_Q2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
