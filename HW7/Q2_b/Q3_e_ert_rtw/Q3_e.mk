###########################################################################
## Makefile generated for component 'Q3_e'. 
## 
## Makefile     : Q3_e.mk
## Generated on : Tue May 30 21:50:06 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Q3_e.elf
...
PRODUCT_NAME              = Q3_e
MAKEFILE                  = Q3_e.mk
MATLAB_ROOT               = D:/Apps/MATLAB/R2022a
MATLAB_BIN                = D:/Apps/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/Telegram/Embedded Systems/HW7/Q2_b
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
SLIB_PATH                 = C:/Users/efnos/DOCUME~1/MATLAB/R2022a/ARDUIN~1/ARDUIN~2/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Q3_e.elf
...
DEFINES_STANDARD = -DMODEL=Q3_e -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Q3_e.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Q3_e_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Q3_e_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
Q3_e.o : $(START_DIR)/Q3_e_ert_rtw/Q3_e.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Q3_e_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Q3_e_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Q3_e_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Q3_e_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
