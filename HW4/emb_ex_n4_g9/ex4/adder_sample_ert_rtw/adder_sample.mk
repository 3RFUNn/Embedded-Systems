###########################################################################
## Makefile generated for component 'adder_sample'. 
## 
## Makefile     : adder_sample.mk
## Generated on : Fri Apr 21 22:18:41 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/adder_sample.elf
...
SLIB_PATH                 = C:/Users/PARSAN~1/DOCUME~1/MATLAB/R2022a/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/adder_sample.elf
...
DEFINES_STANDARD = -DMODEL=adder_sample -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = adder_sample.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/adder_sample_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/adder_sample_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/adder_sample_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
adder_sample.o : $(START_DIR)/adder_sample_ert_rtw/adder_sample.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/adder_sample_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
