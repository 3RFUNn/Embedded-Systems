...
## 
## Makefile     : Q4.mk
## Generated on : Sun Apr 23 16:56:09 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Q4.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Q4.elf
...
DEFINES_STANDARD = -DMODEL=Q4 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = Q4.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/Q4_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Q4_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
Q4.o : $(START_DIR)/Q4_ert_rtw/Q4.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Q4_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
